...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/NarrativeForge/config.toml'
...
project_name = _cfg.get("project_name", "NarrativeForge")
project_description = _cfg.get(
    "project_description",
    "Agent-first orchestration for auditable narrative media workflows.",
)
project_version = _cfg.get("project_version", __version__)
reload_debug = False

app["redis_host"] = os.getenv(
    "NARRATIVEFORGE_APP_REDIS_HOST",

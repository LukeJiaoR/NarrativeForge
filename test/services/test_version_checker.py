...
@patch.object(
    ...
    "https://api.github.com/repos/example/narrativeforge/releases/latest",
)
class TestVersionChecker(unittest.TestCase):
    ...
    def test_prerelease_comparison_uses_semantic_versions(self, request_get):
        request_get.return_value = self._response("v0.1.0")

        result = version_checker.get_available_update("0.1.0rc1")
